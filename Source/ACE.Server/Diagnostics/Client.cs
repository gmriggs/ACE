...
using ACE.Server.Diagnostics.Packet;
using ProtoBuf;
using ProtoBuf.Meta;
...
namespace ACE.Server.Diagnostics
{
    ...
    public class Client
    {
        ...
        public void ShowResponse(byte[] responseBytes)
        {
            ...
            switch (packetType)
            {
                ...
                case PacketType.GameState:
                    var gameState = new GameState(responseBytes);
        ...
        public Packet.Packet GetPacket(byte[] responseBytes)
        {
            ...
            switch (packetType)
            {
                ...
                case PacketType.PingRequest:
                    ...
                    break;
                case PacketType.GameState:
                    packet = new GameState(responseBytes);
                    break;
            }
        ...
        public void ProcessQueue()
        {
            ...
            if (Timer.Elapsed.TotalSeconds > lastUpdate + 1.0f)
            {
                lastUpdate = Timer.Elapsed.TotalSeconds;
                //Console.WriteLine("Processed " + NumPackets + " in last second (" + NumBytes + " bytes)");
                NumPackets = 0;
                NumBytes = 0;
            }
        }
