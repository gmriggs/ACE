    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("healing_difficulty", new Property<double>(2.0, "The difficulty of using a healing kit. Defaults to the wiki value of 2.0.")),
                ("healing_min_percent", new Property<double>(0.2, "The minimum percent of healing skill to restore to vital. Defaults to 0.2")),
                ("healing_max_percent", new Property<double>(0.5, "The minimum percent of healing skill to restore to vital. Defaults to 0.5")),
